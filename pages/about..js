...
import { TwoColuem } from "./components/two-colum";
import { TwoColuemMain } from "./components/two-colum";
import { TwoColuemSide } from "./components/two-colum";
import eyecach from "../images/about.jpg";
...
export default function About() {
    return(
        <Container>
          <Meta 
          pageTitle={"アバウト"} 
          pageDesc={"Aboutdevelopment activities"}
          pageImg={eyecach.src}
          pageImgW={eyecach.width}
          pageImgH={eyecach.height}
          />
            <Hero title={"About"} subtitle={"About development activies"} />
            <figure>
              <Image
                src={eyecach}
                alt=""
